...
export function buildAgentManifest({
  ...
  return {
    model: {
      name: modelName,
      params: { max_tokens: 8192, temperature: 0.2, parallel_tool_calls: true },
    },
